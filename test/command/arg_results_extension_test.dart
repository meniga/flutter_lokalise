  ...
  group("arg results extension", () {
    ...
    group("with default", () {
      test("should prefer arguments to fallback value", () {
        ...
        // then
        expect(results.get("with-default", orElse: "else"), equals("from arguments"));
      });
      ...
      test("should prefer fallback value to default", () {
        ...
        // then
        expect(results.get("with-default", orElse: "fallback"), equals("fallback"));
      });
      ...
      test("should return default value if no other provided", () {
        ...
        // then
        expect(results.get("with-default"), equals("default"));
      });
    });
    ...
    group("no default", () {
      test("should prefer arguments to fallback value", () {
        ...
        // then
        expect(results.get("no-default", orElse: "else"), equals("from arguments"));
      });
      ...
      test("should return fallback value if no arguments provided", () {
        ...
        // then
        expect(results.get("no-default", orElse: "fallback"), equals("fallback"));
      });
      ...
      test("should return null if no fallback provided", () {
        ...
        // then
        expect(results.get("no-default"), isNull);
      });
    });
    ...
    group("multi option", () {
      test("should prefer arguments to fallback value", () {
        ...
        // then
        expect(results.get("multi-option", orElse: ["fallback"]), equals(["1", "2"]));
      });
      ...
      test("should prefer fallback value to default", () {
        ...
        // then
        expect(results.get("multi-option", orElse: ["fallback"]), equals(["fallback"]));
      });
      ...
      test("should return empty if no fallback provided", () {
        ...
        // then
        expect(results.get("multi-option"), isEmpty);
      });
    });
  });
}
